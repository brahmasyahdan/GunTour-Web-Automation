...
public class BookingHistoryPage extends PageObject {
    ...
    private final By buttonPayNow= By.xpath("/html/body/div/div/div/section/section[1]/div/div/a/button");
    private final By deleteButton= By.xpath("/html/body/div/div/div/section/section[1]/div/div/div");
    private final By statusProduct=By.xpath("/html/body/div/div/div/section/section[1]/div/p[2]");
